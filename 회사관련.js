...
------------------------------------------------------------------
권한관련 문제 해결방법 (UI화면에서 사용자권한이 없습니다 라고 뜰 떄 )
-PL님이 올려주신 내용참조
------------------------------------------------------------------
상용 DB(?)에 반영할 때
...
UPDATE T_ADM_Controller_O SET IP = :IP where Equipseq = :EquipSeq ; 이라는 쿼리가 있다면
...
set 부분에 넣는건 tempOutSub2에 값 넣어 주고 .update 해줘야 함
------------------------------------------------------------------
db 테이블에 컬럼 추가 하는 방법
