...
exports.update = function(request, response) {
  db.query('SELECT * FROM topic', function(error, topics){
   ...
   db.query(`SELECT * FROM topic WHERE id=?`,[queryData.id], function(error2, topic){
     ...
     db.query(`SELECT * FROM author`, function(error2,authors){
     var list = template.list(topics);
     console.log("-----------update log ---topic--start----------------");
     console.log(topic[0]);
     console.log("-----------update log ---topic--end----------------");
...
exports.update_process = function(request, response) {
  ...
  request.on('data', function(data){
      body = body + data;
      console.log("-----------update_process log---body--start---------------");
      console.log(body); //화면에서 입력한 값.
      console.log("-----------update_process log---body--end-------------");
  });
  request.on('end', function(){
      var post = qs.parse(body);
      console.log("-----------222update_process log---post--start-------------");
      console.log(post);
      console.log("-----------222update_process log---post--body-------------");
      console.log(post);
